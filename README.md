...
> [!IMPORTANT]
> Нулевой скрипт обновит полностью систему, при необходимости надо закомментировать вторую строку, Также закоментируем строку с пакетом `rsyslog`, он нам не понадобится.
